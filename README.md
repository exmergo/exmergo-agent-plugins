# Exmergo Agent Plugins

Open plugins for AI coding agents from [Exmergo](https://www.exmergo.com), the team
...
the skills they ship also work in other coding agents
(see [Beyond Claude Code](#beyond-claude-code)).

This repository is a Claude Code plugin marketplace. Add it once, then install any
plugin in the catalog. It is part of the work we share at
...
To pull the latest catalog and plugin versions later:

```
/plugin marketplace update exmergo
```
...
Each plugin lives in its own repository, with its own README, examples, and issues. This
